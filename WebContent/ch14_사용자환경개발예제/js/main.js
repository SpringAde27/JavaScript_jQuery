$(function(){
	...
	//$("#roll_banner_wrap dd").next(":first").hide();
	...
	$(".stopBtn").on("click",function(){
		...
		$(".playBtn img",this).attr("src",$(".playBtn img",this).attr("src").replace("on.gif","off.gif"));
	...
	$("#tabmenu dt a").on("mouseover focus click",function(){
		...
		$(onTab).find("img").attr("src",$("img",onTab).attr("src").replace("over.gif","out.gif"));
